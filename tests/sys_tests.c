...
static bool testSysAddRoom(){
    ...
    ASSERT_TEST(escapeTechnionCreate(&sys)==ESCAPE_TECHNION_SUCCESS);
    ASSERT_TEST(escapeTechnionAddCompany(sys,"eecompany1@",ELECTRICAL_ENGINEERING)==ESCAPE_TECHNION_SUCCESS);
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",1,PRICE_MODULE,4,0,24,1)==ESCAPE_TECHNION_SUCCESS);
    //null check
    //ASSERT_TEST(escapeTechnionAddRoom(sys,NULL,1,4,1,0,24,1)==ESCAPE_TECHNION_NULL_PARAMETER);
    //Parameters check
    ASSERT_TEST((result=escapeTechnionAddRoom(sys,"eecompany1",1,4,1,0,24,1))==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",-1,4,1,0,24,1)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",3,3,1,0,24,1)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",3,3,1,0,25,1)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",3,3,1,0,24,10)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",3,3,1,0,24,-1)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",3,3,1,-1,24,1)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(result=escapeTechnionAddRoom(sys,"check12@gmail.com",-1,4,1,0,24,1)==ESCAPE_TECHNION_INVALID_PARAMETER);
    //MTM COMPANY-NOT_EXIST
    ASSERT_TEST(result=escapeTechnionAddRoom(sys,"check12@gmail.com",1,4,1,0,24,1)==ESCAPE_TECHNION_COMPANY_EMAIL_DOES_NOT_EXIST);
   //MTM_ID_EXISTS
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",1,PRICE_MODULE*2,1,0,24,1)==ESCAPE_TECHNION_ID_ALREADY_EXIST);
    escapeTechnionDestroy(sys);
    return true;
}
...
static bool testSysRemoveRoom(){
    ...
    ASSERT_TEST(escapeTechnionAddClient(sys,"escaper1@",ELECTRICAL_ENGINEERING,2)==ESCAPE_TECHNION_SUCCESS);
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",ELECTRICAL_ENGINEERING,1,0,12,3)==ESCAPE_TECHNION_SUCCESS);
    ASSERT_TEST(escapeTechnionRemoveRoom(sys,ELECTRICAL_ENGINEERING,1)==ESCAPE_TECHNION_RESERVATION_EXISTS);
    //SUCCESS
...
static bool testAddClient(){
   ...
   // ASSERT_TEST(escapeTechnionAddClient(NULL,"RANDOMNAME@gmail.com",MEDICINE,1)==ESCAPE_TECHNION_NULL_PARAMETER);
    ...
    ASSERT_TEST(escapeTechnionAddClient(sys,"mynameis@gmail.com",-1,1)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddClient(sys,"mynameis@gmail.com",20,1)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddClient(sys,"mynameis@gmail.com",0,0)==ESCAPE_TECHNION_INVALID_PARAMETER);
    ASSERT_TEST(escapeTechnionAddClient(sys,"mynameis@gmail.com",0,11)==ESCAPE_TECHNION_INVALID_PARAMETER);
    //Test same mail
...
static bool testAddOrder(){
    ...
    ASSERT_TEST(escapeTechnionAddCompany(sys,"eecompany1@",ELECTRICAL_ENGINEERING)==ESCAPE_TECHNION_SUCCESS);
    ASSERT_TEST(escapeTechnionAddRoom(sys,"eecompany1@",1,4,1,0,24,1)==ESCAPE_TECHNION_SUCCESS);
    ASSERT_TEST(escapeTechnionAddClient(sys,"escaper1@",MEDICINE,1)==ESCAPE_TECHNION_SUCCESS);
    //Null tests
    //Test parameters
    ASSERT_TEST(escapeTechnionAddOrder(sys,"WHATDOESTHEFOXSAY?",1,1,1,1,1)==ESCAPE_TECHNION_INVALID_PARAMETER);//MAIL CHECK
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",-1,1,1,00,1)==ESCAPE_TECHNION_INVALID_PARAMETER);//FACULTY CHECK
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",20,1,1,00,1)==ESCAPE_TECHNION_INVALID_PARAMETER);//FACULTY CHECK
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",1,0,1,00,1)==ESCAPE_TECHNION_INVALID_PARAMETER);//ID CHECK
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",1,1,-1,00,1)==ESCAPE_TECHNION_INVALID_PARAMETER);//DAY CHECK
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",1,1,0,-1,1)==ESCAPE_TECHNION_INVALID_PARAMETER);//HOUR CHECK
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",1,1,0,25,1)==ESCAPE_TECHNION_INVALID_PARAMETER);//HOUR CHECK
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",1,1,0,12,0)==ESCAPE_TECHNION_INVALID_PARAMETER);//ppl CHECK
    //Client does not exist
    ASSERT_TEST(escapeTechnionAddOrder(sys,"IkillYOU!@gmail.com",ELECTRICAL_ENGINEERING,1,0,12,3)==ESCAPE_TECHNION_CLIENT_EMAIL_DOES_NOT_EXIST);
    //Test ROOM id does not exist
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",ELECTRICAL_ENGINEERING,11,0,12,3)==ESCAPE_TECHNION_ID_DOES_NOT_EXIST);
    //TEST CLIENT IN ROOM
    escapeTechnionAddRoom(sys,"eecompany1@",2,PRICE_MODULE,3,0,21,5);
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",ELECTRICAL_ENGINEERING,1,0,0,1)==ESCAPE_TECHNION_SUCCESS);//ESCAPER 1 FOR ROOM 1 TODAY AT 0
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",ELECTRICAL_ENGINEERING,2,0,0,1)==ESCAPE_TECHNION_CLIENT_IN_ROOM);
    //room unavailable
    escapeTechnionAddClient(sys,"escaper2@",ELECTRICAL_ENGINEERING,2);
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper2@",ELECTRICAL_ENGINEERING,1,0,0,7)==ESCAPE_TECHNION_ROOM_NOT_AVAILABLE);
    escapeTechnionRemoveClient(sys,"escaper1@");
    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper1@",ELECTRICAL_ENGINEERING,1,0,0,7)==ESCAPE_TECHNION_CLIENT_EMAIL_DOES_NOT_EXIST);

    ASSERT_TEST(escapeTechnionAddOrder(sys,"escaper2@",ELECTRICAL_ENGINEERING,1,0,0,7)==ESCAPE_TECHNION_SUCCESS);
